...
export default function Hero() {
  return (
    <section className="relative w-full h-[795px] overflow-hidden bg-[#FAF3E7]">
      ...
      {/* Contenido */}
      <div className="relative z-30 max-w-[1280px] h-full mx-auto px-8 flex items-center">

        <div className="max-w-[640px] flex flex-col gap-6">

          {/* Título */}
          <h1
            className="text-white text-[72px] leading-[78px] font-[800] tracking-[-1px]"
            style={{
          ...
          {/* Subtexto */}
          <p
            className="text-[20px] leading-[30px] text-[#F2E9DC]/90 italic max-w-[520px]"
          ...
          <div className="flex items-center gap-6 pt-6">
            ...
            {/* PRIMARY */}
            <Link href="/concursos">
              <button className="px-10 py-4 bg-[#a3740df2] text-white text-sm tracking-[0.2em] uppercase font-medium 
            ...
            <Link href="/agrupaciones">
              <button className="px-10 py-4 border border-[#F2E9DC]/50 text-[#F2E9DC] text-sm tracking-[0.2em] uppercase font-medium 
