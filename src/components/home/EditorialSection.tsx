...
export default function EditorialSection() {
  return (
    <section className="bg-[#FFF8EF] bg-weave py-32 px-8">
     <div className="max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
        ...
        <div className="md:col-span-7 space-y-12">
          ...
          {/* Title */}
          <h2
            className="text-6xl leading-tight text-[#1E1B14]"
          ...
          {/* Texts */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-[#554240] text-lg leading-relaxed">
        ...
        {/* RIGHT */}
        <div className="md:col-span-5 pt-12 md:pt-0">
          ...
          <div className="relative group">
            ...
            {/* Badge */}
            <div className="absolute -bottom-4 -right-4 bg-[#85332A] text-white px-6 py-4 z-20">
              <span
