// src/app/agrupaciones/[slug]/GroupDetailContent.tsx - TU VERSIÓN ORIGINAL
'use client'
...
export default function GroupDetailContent({ group, gallery, events }: Props) {
    ...
    <main>
      ...
      <section className="relative w-full h-[400px] md:h-[751px] overflow-hidden flex items-end">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#1E1B14]/80 via-transparent to-transparent" />
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-16 items-start">
            ...
            <div className="md:col-span-8 space-y-8">
              <p
                ...
                style={{ fontFamily: 'var(--font-newsreader)' }}
              >
                {group.description || 'Fundada con el compromiso de preservar y difundir las danzas tradicionales de nuestra región.'}
              </p>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      {/* ✅ BOTÓN MÁS INFO QUE ABRÍA MODAL */}
                      <button
